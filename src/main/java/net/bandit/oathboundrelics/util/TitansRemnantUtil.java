...
public final class TitansRemnantUtil {
    ...
    public static int getImpact(Player player) {
        return PersistentData.get(player).getInt(IMPACT_TAG);
    }

    public static void setImpact(Player player, int value) {
        PersistentData.get(player).putInt(IMPACT_TAG, Math.max(0, Math.min(5, value)));
    }

    // Tremor state
    public static int getTremor(Player player) {
        return PersistentData.get(player).getInt(TREMOR_TAG);
    }

    public static void setTremor(Player player, int value) {
        PersistentData.get(player).putInt(TREMOR_TAG, Math.max(0, Math.min(10, value)));
    }
    ...
    public static long getTremorDecayAt(Player player) {
        return PersistentData.get(player).getLong(TREMOR_DECAY_AT_TAG);
    }

    public static void setTremorDecayAt(Player player, long gameTime) {
        PersistentData.get(player).putLong(TREMOR_DECAY_AT_TAG, gameTime);
    }
    ...
    public static int getHeat(Player player) {
        return PersistentData.get(player).getInt(HEAT_TAG);
    }

    public static void setHeat(Player player, int value) {
        PersistentData.get(player).putInt(HEAT_TAG, Math.max(0, Math.min(10, value)));
    }
    ...
    public static long getEmberCauterizeCooldown(Player player) {
        return PersistentData.get(player).getLong(EMBER_CAUTERIZE_CD_TAG);
    }

    public static void setEmberCauterizeCooldown(Player player, long value) {
        PersistentData.get(player).putLong(EMBER_CAUTERIZE_CD_TAG, value);
    }

    // Tide state
    public static long getTideWardCooldown(Player player) {
        return PersistentData.get(player).getLong(TIDE_WARD_CD_TAG);
    }

    public static void setTideWardCooldown(Player player, long value) {
        PersistentData.get(player).putLong(TIDE_WARD_CD_TAG, value);
    }

    // Skybrand state
    public static boolean wasAirborne(Player player) {
        return PersistentData.get(player).getBoolean(WAS_AIRBORNE_TAG);
    }

    public static void setWasAirborne(Player player, boolean value) {
        PersistentData.get(player).putBoolean(WAS_AIRBORNE_TAG, value);
    }

    public static float getStoredAirborneFall(Player player) {
        return PersistentData.get(player).getFloat(AIRBORNE_FALL_TAG);
    }

    public static void setStoredAirborneFall(Player player, float value) {
        PersistentData.get(player).putFloat(AIRBORNE_FALL_TAG, value);
    }

    public static long getSkybrandAscentCooldown(Player player) {
        return PersistentData.get(player).getLong(SKYBRAND_ASCENT_CD_TAG);
    }

    public static void setSkybrandAscentCooldown(Player player, long value) {
        PersistentData.get(player).putLong(SKYBRAND_ASCENT_CD_TAG, value);
    }

    // Nebula state
    public static boolean isNebulaEmpowered(Player player) {
        return PersistentData.get(player).getBoolean(NEBULA_EMPOWERED_TAG);
    }

    public static void setNebulaEmpowered(Player player, boolean value) {
        PersistentData.get(player).putBoolean(NEBULA_EMPOWERED_TAG, value);
    }

    public static long getNebulaBlinkCooldown(Player player) {
        return PersistentData.get(player).getLong(NEBULA_BLINK_CD_TAG);
    }

    public static void setNebulaBlinkCooldown(Player player, long value) {
        PersistentData.get(player).putLong(NEBULA_BLINK_CD_TAG, value);
    }

    public static long getNebulaTeleportWindowAt(Player player) {
        return PersistentData.get(player).getLong(NEBULA_TELEPORT_WINDOW_AT_TAG);
    }

    public static void setNebulaTeleportWindowAt(Player player, long value) {
        PersistentData.get(player).putLong(NEBULA_TELEPORT_WINDOW_AT_TAG, value);
    }
    ...
    public static long getNebulaUnstableReactionCooldown(Player player) {
        return PersistentData.get(player).getLong(NEBULA_UNSTABLE_REACTION_CD_TAG);
    }

    public static void setNebulaUnstableReactionCooldown(Player player, long value) {
        PersistentData.get(player).putLong(NEBULA_UNSTABLE_REACTION_CD_TAG, value);
    }


    public static long getVoidDeathCooldown(Player player) {
        return PersistentData.get(player).getLong(VOID_DEATH_CD_TAG);
    }

    public static void setVoidDeathCooldown(Player player, long value) {
        PersistentData.get(player).putLong(VOID_DEATH_CD_TAG, value);
    }

    public static int getVoidCharges(Player player) {
        return PersistentData.get(player).getInt(VOID_CHARGES_TAG);
    }

    public static void setVoidCharges(Player player, int value) {
        PersistentData.get(player).putInt(VOID_CHARGES_TAG, Math.max(0, Math.min(3, value)));
    }
